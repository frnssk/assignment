...
public class GUISemaphore {
	...
	private int icaItems = 0;
	private int icaWeight = 0;
	private int icaVolume = 0;
	private int coopItems = 0;
	private int coopWeight = 0;
	private int coopVolume = 0;
	private int cgItems = 0;
	private int cgWeight = 0;
	private int cgVolume = 0;
...
//		ActionListner listner = new ActionListner();
		btnStartS.addActionListener(e -> controller.startScan());
		btnStartA.addActionListener(e -> controller.startArla());
		btnStartX.addActionListener(e -> controller.startAxFood());

		btnStopS.addActionListener(e -> controller.stopScan());
		btnStopA.addActionListener(e -> controller.stopArla());
		btnStopX.addActionListener(e -> controller.stopAxFood());
		
		btnIcaStart.addActionListener(e -> controller.startIca());
		btnCoopStart.addActionListener(e -> controller.startCoop());
		btnCGStart.addActionListener(e -> controller.startCityGross());
		
		btnIcaStop.addActionListener(e -> controller.stopIca());
		btnCoopStop.addActionListener(e -> controller.stopCoop());
		btnCGStop.addActionListener(e -> controller.stopCityGross());
	}
